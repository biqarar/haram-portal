...
class model extends main_model {
	public function sql_register() {
		// var_dump("expression");exit();
		$list = $this->sql()->tableBridge()->whereTitle("mobile");
		$list->joinHistory()->whereTable("bridge")->andRecord_id("#bridge.id")->andDate(">", "2015-04-22 00:00:00");
