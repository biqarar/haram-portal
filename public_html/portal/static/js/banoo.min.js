...
}}),$(this).removeAttr("disabled"),!1)})}),route(/score\/calculation\/status\=(add|edit)/,function(){$("#plan_id").combobox("destroy"),$("#plan_id",this).combobox({change:function(b){item=b.item.option.value,$.ajax({type:"POST",url:"score/type/api/id="+item,success:function(b){$("#list").html(""),$("#list").val("");for(a in b.msg)b.msg[a].title&&$("<a  onclick='insert_(this);'>"+b.msg[a].title+"</a><br>").appendTo("#list")}})}})}),route(/users\/status=api/,function(){$("tbody>tr",this).attr("copier-context-subject","user"),console.log(10)}),route(/classification\/class\/classesid\=\d+/,function(){var a;a="#document"==this.nodeName?$("#tabs>div").eq(0):$(this),a.scontextmenu({user:{click:function(){var a=$(this).attr("id"),b=$("#tabs>ul>li[aria-controls='"+a+"'] a"),c=b.attr("href"),d=arguments[1][9],e=(arguments[1][0]+" "+arguments[1][1],b.text(),c.match(/classesid=(\d+)#?.*$/)[1]),f="classification/api/usersid="+d+"/classesid="+e;b.removeClass("copier-true").removeClass("copier-error").addClass("copier-load"),console.log(f),$.ajax({type:"POST",url:f,success:function(a){console.log(a),a.fatal?xhr_error(a.fatal[0]):a.warn?xhr_warn(a.warn[0]):xhr_true(a["true"][0])}})},title:function(){var a=$(this).attr("id"),b=$("#tabs>ul>li[aria-controls='"+a+"'] a");return"ثبت در "+b.text()}}})});
