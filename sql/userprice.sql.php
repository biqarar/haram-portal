...
class userprice {
	...
	public $status    	 = array('type'=> 'enum@fullpayment,debtor,return,invalid', "label" => "status");
	...
	public $value_back   = array('type'=> 'int@7', "label" => "value_back");
	...
	public function value_back() {
		$this->form("text")->name("value_back")->label("مبلغ ارجاع")->pl("به ریال");
		$this->validate()->price()->form->price("price value_back is not valid");
	}
	...
	public function classes_id(){
		$this->form("select")->name("classes_id")->label("classes_id");
		$this->setChild();
	}
