...
class teachinghistory {
	...
	public $name    = array('type'=> 'varchar@255', 'label' => 'teachinghistory_name');
	public $type   = array('type'=> 'enum@cultural,training,administrative,learning', 'label' => 'teachinghistory_type');
