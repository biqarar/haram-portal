...
class education_users {
	...
	public $id           = array("type" => "int@10" , "label" => "education_users_id");
	public $users_id     = array("type" => "int@10" , "label" => "users_id");
	public $education_id = array("type" => "int@10" , "label" => "education_id");
	public $year         = array("type" => "int@4" , "label" => "education_users_year");
	public $field        = array("type" => "varchar@255" , "label" => "education_users_field");
	public $average      = array("type" => "float@" , "label" => "education_users_average");
	public $trend        = array("type" => "varchar@255" , "label" => "education_users_trendw");
